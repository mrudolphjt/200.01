...
## Compact Rippling Embed Version

This version removes the large top banner/hero, reduces the page top padding, removes the extra journey top margin, and changes the lesson panel height from a fixed minimum height to automatic height. These changes are intended to reduce the internal iframe scrolling when embedded in Rippling.

After uploading the updated `index.html` to GitHub, refresh the GitHub Pages URL and then refresh the Rippling lesson preview.
